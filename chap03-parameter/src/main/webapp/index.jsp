...
<body>
    ...
    <form action="post-request" method="post">
        ...
        <input type="checkbox" name="hobbies" id="music2" value="movie"/><label for="music">음악</label>
        <input type="checkbox" name="hobbies" id="sleep2" value="movie"/><label for="sleep">수면</label>
        <button type="submit">전송하기</button>
    </form>
</body>
</html>